  ...
  return (
    <div className="flex flex-col lg:h-[90vh] h-[100vh] bg-transparent">
      <div>
        {/* Yes/No options */}
        {isCertified === null && (
          <div className="flex flex-col lg:flex-row-reverse lg:space-x-4 lg:space-y-0 space-y-14 w-full">
            ...
            <div className="lg:w-3/5 w-full bg-white rounded-md flex flex-col justify-center items-center text-black lg:h-[90vh] lg:px-24 px-6 py-6">
      ...
      {/* If user selects 'Yes' */}
      {isCertified === true && (
        <div className="w-full flex flex-col-reverse lg:flex-row justify-center lg:justify-between items-center pt-10 lg:pt-28">
