  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="flex flex-col items-center justify-center text-center h-full px-8">
        ...
        <div className="absolute bottom-5 left-[40%] z-20 flex justify-center gap-x-4 items-center">
          <div className="px-4">
            <Image src="https://www.mowash.in/_next/image?url=%2FImages%2Flogo1.png&w=128&q=75" width={160} height={130} alt="logo" />
            <p className="text-white">An Initiative by</p>
          </div>
          <div className="px-4">
            <Image src="https://res.cloudinary.com/dgtc2fvgu/image/upload/v1726660522/1200px-UNICEF_Logo_gfi4tc.png" width={160} height={130} alt="logo" />
            <p className="text-white mt-5">Supported by</p>
          </div>
        </div>
